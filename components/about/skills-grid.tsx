...
const skillColors = [
  { bg: "bg-football-green/10", border: "border-football-green/20", text: "text-football-green", iconBg: "bg-football-green/20", glowRgba: "rgba(0,214,108,0.15)" },
  { bg: "bg-ai-blue/10",        border: "border-ai-blue/20",        text: "text-ai-blue",        iconBg: "bg-ai-blue/20",        glowRgba: "rgba(0,102,255,0.15)" },
  { bg: "bg-tech-purple/10",    border: "border-tech-purple/20",    text: "text-tech-purple",    iconBg: "bg-tech-purple/20",    glowRgba: "rgba(139,92,246,0.15)" },
  { bg: "bg-energy-orange/10",  border: "border-energy-orange/20",  text: "text-energy-orange",  iconBg: "bg-energy-orange/20",  glowRgba: "rgba(255,107,53,0.15)" },
  { bg: "bg-football-green/10", border: "border-football-green/20", text: "text-football-green", iconBg: "bg-football-green/20", glowRgba: "rgba(0,214,108,0.15)" },
  { bg: "bg-ai-blue/10",        border: "border-ai-blue/20",        text: "text-ai-blue",        iconBg: "bg-ai-blue/20",        glowRgba: "rgba(0,102,255,0.15)" },
] as const;
