...
export const formations = [
  {
    ...
    positions: [
      ...
      { x: 35, y: 42, position: "CM", number: 10, name: "Central Midfielder (L)" },
      { x: 50, y: 48, position: "CDM", number: 6, name: "Defensive Midfielder" },
  ...
  },
  {
    ...
    positions: [
      ...
      { x: 38, y: 48, position: "CM", number: 6, name: "Central Midfielder (L)" },
      { x: 62, y: 52, position: "CM", number: 8, name: "Central Midfielder (R)" },
